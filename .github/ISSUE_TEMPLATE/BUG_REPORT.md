---
name: VisualizationBase.jl bug report
about: Create a bug report to help us improve VisualizationBase.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("VisualizationBase")`:
```julia
julia> using Pkg; Pkg.status("VisualizationBase")
[YOUR OUTPUT HERE]
```
